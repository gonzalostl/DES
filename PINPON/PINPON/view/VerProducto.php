...
<head>
    ...
    <title><?=$_POST['accion']?> Producto</title>
...
<body>
    ...
    <div class="container-sm col-sm" style="padding-top:40px;">
        ...
        <form method="post" action="../controller/<?=$_POST['accion']?>ProductoController.php">
            ...
            <input type=hidden name='idProducto' value='<?=(isset($_POST['idProducto'])?$_POST['idProducto']:'')?>'
