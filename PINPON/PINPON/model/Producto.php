...
class Producto
{
    ...
    /**
     * La funcion borra el producto que se precio > 20
     */
    public static function delProducto20($pdo)
    {
        try {
            //Borramos todos los productos con nombre Pala bullpadel 2
            $query = "DELETE from productos where precio > 20";
    ...
    public static function insertProducto($pdo, $producto)
    {
        ...
        try {
            ...
            $query = "INSERT INTO productos  (nombre,descripcion,peso,precio,tamano)  VALUES (:nombre,:descripcion,:peso,:precio,:tamano)";
