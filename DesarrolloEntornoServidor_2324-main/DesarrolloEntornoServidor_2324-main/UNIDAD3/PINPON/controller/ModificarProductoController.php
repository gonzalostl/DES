...
$idProd = ModelUtils::validarDatos($_POST['idProducto']);
...
$prod_nuevo=['idProductos'=> $idProd, 'nombre'=>$nombre, 'descripcion'=>$descripcion,'peso'=>$peso,'precio'=>$precio,'tamano'=>$tamano];
